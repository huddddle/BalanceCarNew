...
build-363746033: ../mspm0-modules.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"D:/TI/ccs/utils/sysconfig_1.24.0/sysconfig_cli.bat" --script "D:/Electric/My_TI_Workspace/BalanceCarNew/mspm0-modules.syscfg" -o "." -s "C:/TI/mspm0_sdk_2_04_00_06/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-363746033 ../mspm0-modules.syscfg
device.opt: build-363746033
device.cmd.genlibs: build-363746033
ti_msp_dl_config.c: build-363746033
ti_msp_dl_config.h: build-363746033
Event.dot: build-363746033
